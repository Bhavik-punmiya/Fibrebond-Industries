...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const changeLogoUrl = () => {
    setLogoUrl('https://i0.wp.com/fibrebondindustries.com/wp-content/uploads/2023/10/FBI_logo_v4_185x_2x.png?fit=370%2C107&ssl=1');
  }
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/ui/alerts" && "text-white"
                              }`}
                            >
                              Alerts
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/ui/buttons" && "text-white"
                              }`}
                            >
                              Buttons
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/auth/signin" && "text-white"
                              }`}
                            >
                              Sign In
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/auth/signup" && "text-white"
                              }`}
                            >
                              Sign Up
                            </Link>
